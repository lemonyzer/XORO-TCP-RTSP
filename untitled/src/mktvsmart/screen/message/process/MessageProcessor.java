...
public class MessageProcessor
{
    ...
    private void dispatchMessage(final Message message) {
        ...
        if (map != null) {
            for (final Activity activity : map.keySet()) {
                ...
                final MessageProcessor.PerformOnBackground performOnBackground = list.get(0);
                final MessageProcessor.PerformOnForeground performOnForeground = (MessageProcessor.PerformOnForeground)list.get(1);
                if (performOnBackground != null && (activity == null || (activity != null && !activity.isFinishing()))) {
                    this.mWorkerThreadPool.submit((Runnable)new MessageProcessor.MessageProcessor$3(this, performOnBackground, message2));
                }
                if (performOnForeground != null && activity != null && !activity.isFinishing()) {
                    activity.runOnUiThread((Runnable)new MessageProcessor.MessageProcessor$4(this, performOnForeground, message2));
                }
            }
        }
    }
    ...
    public boolean postMessageAtFrontOfQueue(final Message message) {
        if (message != null && this.messageReceiver != null) {
            ...
            final Message obtain = Message.obtain(MessageProcessor.sMessageHandler, (Runnable)new MessageProcessor.MessageProcessor$2(this, message));
    ...
    public boolean postMessageAtTime(final Message message, final Object obj, final long n) {
        if (message != null && this.messageReceiver != null) {
            ...
            final Message obtain = Message.obtain(MessageProcessor.sMessageHandler, (Runnable)new MessageProcessor.MessageProcessor$1(this, message));
            obtain.what = message.what;
            obtain.arg1 = message.arg1;
            obtain.arg2 = message.arg2;
            obtain.obj = obj;
    ...
    public void setOnMessageProcess(final int n, final Activity activity, final MessageProcessor.PerformOnBackground performOnBackground) {
        this.setOnMessageProcess(n, activity, performOnBackground, null);
    }

    public void setOnMessageProcess(final int n, final Activity activity, final MessageProcessor.PerformOnBackground performOnBackground, final MessageProcessor.PerformOnForeground performOnForeground) {
        final ArrayList<MessageProcessor.PerformOnBackground> list = new ArrayList<MessageProcessor.PerformOnBackground>();
        final Map map = (Map)this.messageMappingList.get(n);
        if (list.add(performOnBackground) && list.add((MessageProcessor.PerformOnBackground)performOnForeground)) {
            Map<Activity, ArrayList<MessageProcessor.PerformOnBackground>> map2;
            if ((map2 = (Map<Activity, ArrayList<MessageProcessor.PerformOnBackground>>)map) == null) {
                map2 = new HashMap<Activity, ArrayList<MessageProcessor.PerformOnBackground>>();
            }
    ...
    public void setOnMessageProcess(final int n, final Activity activity, final MessageProcessor.PerformOnForeground performOnForeground) {
        this.setOnMessageProcess(n, activity, null, performOnForeground);
    }

    public void setOnMessageProcess(final int n, final MessageProcessor.PerformOnBackground performOnBackground) {
