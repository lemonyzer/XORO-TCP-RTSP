...
public class XmlParser implements mktvsmart.screen.dataconvert.parser.DataParser {
    ...
    public java.util.List parse(java.io.InputStream a, int i) throws XMLStreamException {
    ...
    private List ParseSatList(InputStream a, int i) throws XMLStreamException {
    ...
    public java.util.List ParseChannelList(java.io.InputStream a, int i) throws XMLStreamException {
